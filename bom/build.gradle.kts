...
bomGenerator {
    ...
    // region Core
    includeDependency("com.firework.core.di", "di-core", "8.0.3")
    includeDependency("com.firework.core.di", "di-android", "8.0.3")
    ...
    includeDependency("com.firework.core", "player", "8.4.1")
