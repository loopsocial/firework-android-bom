...
bomGenerator {
    // region Firework SDK
    val fireworkSdkVersion = "6.29.1.1"
    ...
    // region Core
    includeDependency("com.firework.core.di", "di-core", "8.0.2")
    includeDependency("com.firework.core.di", "di-android", "8.0.2")
    ...
    includeDependency("com.firework.core", "player", "8.3.6")
