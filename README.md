...
```kotlin
val fireworkBomVersion = "2026.04.21"
...
| Dependency                                        | Version |
| :------------------------------------------------ |:--------|
| com.firework:sdk                                  | 6.31.4  |
| com.firework.external.imageloading:glide          | 6.31.4  |
| com.firework.external.imageloading:picasso        | 6.31.4  |
| com.firework.external.livestream:multiHostPlayer  | 6.31.4  |
| com.firework.external.livestream:singleHostPlayer | 6.31.4  |
