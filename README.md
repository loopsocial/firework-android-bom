...
```kotlin
val fireworkBomVersion = "2025.10.21"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.25.2  |
| com.firework.external.imageloading:glide          | 6.25.2  |
| com.firework.external.imageloading:picasso        | 6.25.2  |
| com.firework.external.livestream:multiHostPlayer  | 6.25.2  |
| com.firework.external.livestream:singleHostPlayer | 6.25.2  |
