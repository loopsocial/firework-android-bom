...
```kotlin
val fireworkBomVersion = "2026.06.04"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.32.6  |
| com.firework.external.imageloading:glide          | 6.32.6  |
| com.firework.external.livestream:singleHostPlayer | 6.32.6  |
