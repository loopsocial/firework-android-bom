...
```kotlin
val fireworkBomVersion = "2025.03.04"
...
| Dependency                                        | Version |
|:--------------------------------------------------|:--------|
| com.firework:sdk                                  | 6.17.1  |
| com.firework.external.imageloading:glide          | 6.17.1  |
| com.firework.external.imageloading:picasso        | 6.17.1  |
| com.firework.external.livestream:multiHostPlayer  | 6.17.1  |
| com.firework.external.livestream:singleHostPlayer | 6.17.1  |
