...
```kotlin
val fireworkBomVersion = "2025.09.26"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.24.2  |
| com.firework.external.imageloading:glide          | 6.24.2  |
| com.firework.external.imageloading:picasso        | 6.24.2  |
| com.firework.external.livestream:multiHostPlayer  | 6.24.2  |
| com.firework.external.livestream:singleHostPlayer | 6.24.2  |
