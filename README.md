...
```kotlin
val fireworkBomVersion = "2025.12.11"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.27.2  |
| com.firework.external.imageloading:glide          | 6.27.2  |
| com.firework.external.imageloading:picasso        | 6.27.2  |
| com.firework.external.livestream:multiHostPlayer  | 6.27.2  |
| com.firework.external.livestream:singleHostPlayer | 6.27.2  |
