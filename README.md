...
```kotlin
val fireworkBomVersion = "2025.07.07"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.22.2  |
| com.firework.external.imageloading:glide          | 6.22.2  |
| com.firework.external.imageloading:picasso        | 6.22.2  |
| com.firework.external.livestream:multiHostPlayer  | 6.22.2  |
| com.firework.external.livestream:singleHostPlayer | 6.22.2  |
