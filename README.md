...
```kotlin
val fireworkBomVersion = "2026.08.16"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.34.3  |
| com.firework.external.imageloading:glide          | 6.34.3  |
| com.firework.external.livestream:singleHostPlayer | 6.34.3  |
