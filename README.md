...
```kotlin
val fireworkBomVersion = "2025.03.26"
...
| Dependency                                        | Version |
|:--------------------------------------------------|:--------|
| com.firework:sdk                                  | 6.18.0  |
| com.firework.external.imageloading:glide          | 6.18.0  |
| com.firework.external.imageloading:picasso        | 6.18.0  |
| com.firework.external.livestream:multiHostPlayer  | 6.18.0  |
| com.firework.external.livestream:singleHostPlayer | 6.18.0  |
