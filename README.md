...
```kotlin
val fireworkBomVersion = "2026.03.05"
...
| Dependency                                        | Version |
| :------------------------------------------------ |:--------|
| com.firework:sdk                                  | 6.30.1  |
| com.firework.external.imageloading:glide          | 6.30.1  |
| com.firework.external.imageloading:picasso        | 6.30.1  |
| com.firework.external.livestream:multiHostPlayer  | 6.30.1  |
| com.firework.external.livestream:singleHostPlayer | 6.30.1  |
