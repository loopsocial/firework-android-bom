...
```kotlin
val fireworkBomVersion = "2025.12.03"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.26.4  |
| com.firework.external.imageloading:glide          | 6.26.4  |
| com.firework.external.imageloading:picasso        | 6.26.4  |
| com.firework.external.livestream:multiHostPlayer  | 6.26.4  |
| com.firework.external.livestream:singleHostPlayer | 6.26.4  |
