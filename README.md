...
```kotlin
val fireworkBomVersion = "2025.09.17"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.24.1  |
| com.firework.external.imageloading:glide          | 6.24.1  |
| com.firework.external.imageloading:picasso        | 6.24.1  |
| com.firework.external.livestream:multiHostPlayer  | 6.24.1  |
| com.firework.external.livestream:singleHostPlayer | 6.24.1  |
