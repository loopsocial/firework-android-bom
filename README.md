...
```kotlin
val fireworkBomVersion = "2026.09.15"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.35.1  |
| com.firework.external.imageloading:glide          | 6.35.1  |
| com.firework.external.livestream:singleHostPlayer | 6.35.1  |
...
| com.firework.core:player                          | 8.4.1   |
