...
```kotlin
val fireworkBomVersion = "2026.02.03"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.28.5  |
| com.firework.external.imageloading:glide          | 6.28.5  |
| com.firework.external.imageloading:picasso        | 6.28.5  |
| com.firework.external.livestream:multiHostPlayer  | 6.28.5  |
| com.firework.external.livestream:singleHostPlayer | 6.28.5  |
