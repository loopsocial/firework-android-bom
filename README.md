...
```kotlin
val fireworkBomVersion = "2026.05.25"
...
| Dependency                                        | Version |
| :------------------------------------------------ |:--------|
| com.firework:sdk                                  | 6.32.4  |
| com.firework.external.imageloading:glide          | 6.32.4  |
| com.firework.external.livestream:singleHostPlayer | 6.32.4  |
