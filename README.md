...
```kotlin
val fireworkBomVersion = "2026.01.22"
...
| Dependency                                        | Version |
| :------------------------------------------------ | :------ |
| com.firework:sdk                                  | 6.28.2  |
| com.firework.external.imageloading:glide          | 6.28.2  |
| com.firework.external.imageloading:picasso        | 6.28.2  |
| com.firework.external.livestream:multiHostPlayer  | 6.28.2  |
| com.firework.external.livestream:singleHostPlayer | 6.28.2  |
