...
```kotlin
val fireworkBomVersion = "2026.02.17.1"
...
| Dependency                                        | Version |
| :------------------------------------------------ |:--------|
| com.firework:sdk                                  | 6.29.1.1  |
| com.firework.external.imageloading:glide          | 6.29.1.1  |
| com.firework.external.imageloading:picasso        | 6.29.1.1  |
| com.firework.external.livestream:multiHostPlayer  | 6.29.1.1  |
| com.firework.external.livestream:singleHostPlayer | 6.29.1.1  |
...
| com.firework.core:player                          | 8.3.6   |
...
| com.firework.core.network:web-socket              | 8.2.0   |
